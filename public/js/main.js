...
function displayResults(pnrResult, displayPnrOptions, fareDetails, baggageDetails, checkboxOutputs, pnrProcessingAttempted) {
    ...
    if (flights.length > 0) {
        ...
        flights.forEach((flight, i) => {
            ...
            const departureString = `${flight.departure.airport}${depTerminalDisplay} - ${flight.departure.city} (${flight.departure.country}), ${flight.departure.name} at <strong style="color: black;">${flight.departure.time}</strong>`;
